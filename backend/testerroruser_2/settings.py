"""
Django settings for testerroruser_2 project.
...
ROOT_URLCONF = 'testerroruser_2.urls'
...
WSGI_APPLICATION = 'testerroruser_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testerroruser_2 API",
    "DESCRIPTION": "API documentation for testerroruser_2 App",
    "VERSION": "v1",
}
